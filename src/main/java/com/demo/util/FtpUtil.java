...
public class FtpUtil {
    ...
    public static void main(String[] args) throws Exception{  
            ...
            File file = new File("D:/WordFile/java/workspace/JavaSE/blog/src/main/webapp/upload/Oracle配置.txt");  
            //FtpUtil.upload(file);//把文件上传在ftp上
            FtpUtil.startDown(f,"D:/WordFile/java/workspace/JavaSE/blog/src/main/webapp/upload/","/");//下载ftp文件测试
