...
<div class="container">
  <div class="siteIcon"><img src="<%=basePath %>/Admin/images/icon/icon.png" alt="" data-toggle="tooltip" data-placement="top" title="欢迎使用异清轩博客管理系统" draggable="false" /></div>
  <form action="<%=basePath %>/Admin/login" method="post" autocomplete="off" class="form-signin">
    ...
    <input type="password" id="userPwd" name="pwd" class="form-control" placeholder="请输入密码" required autocomplete="off" maxlength="18">
    <a href="main.html"><button class="btn btn-lg btn-primary btn-block" type="submit" id="signinSubmit">登录</button></a>
  </form>
  <div class="footer">
    <p><a href="<%=basePath %>/blog/index" data-toggle="tooltip" data-placement="left" title="不知道自己在哪?">去博客看看 →</a></p>
  </div>
</div>
