    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
        <div class="col-md-5">
          ...
          <form action="<%=basePath %>/Admin/category_add" method="post" autocomplete="off">
                      ...
                      <c:when test="${categoryList!=null && fn:length(categoryList)>0}">
                         <c:forEach items="${categoryList}" var="category" varStatus="list">
	                       <tr>
			                  ...
			                  <td><a href="<%=basePath %>/Admin/category_update?id=${category.id}">修改</a> 
			                      <a rel="1" href="<%=basePath %>/Admin/category_delete?id=${category.id}">删除</a></td>
			              </tr>
			             </c:forEach>
                      </c:when>
                      <c:otherwise>
                          <tr>
			                  <td colspan="5" style="text-align:center;">没有与之匹配的数据</td>
			              </tr>
                      </c:otherwise>
                   </c:choose>
              </tbody>
